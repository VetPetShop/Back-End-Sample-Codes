...
public class PetServiceImpl implements PetService{
	...
	public String addPets(NewPetDto petdto) {
		...
		Users seller = userRepo.findByFirstNameAndLastName(petdto.getSellerFirstName(), petdto.getSellerLastName()).orElseThrow(() -> new EntityNotFoundException("Breed not found"));
		
		Sellers s = sellerRepo.findBySellerId(seller).orElseThrow(() -> new EntityNotFoundException("Seller not found"));
